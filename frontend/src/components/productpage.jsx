...
function ProductPage() {
  return (
    <div className="bg-white min-h-screen px-3 sm:px-4 md:px-6 py-4">
      <div className="max-w-7xl mx-auto bg-white">
        <nav className="flex gap-2 sm:gap-4 lg:gap-9 text-gray-700 mb-4 text-xs sm:text-sm font-medium justify-start overflow-x-auto pb-2">
...
{/* Product Detail Section         */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 px-0 sm:px-6">
{/* Left section of product section */}
          <div className="flex justify-center">
            <div className="relative inline-block bg-white w-full">
              ...
              <p className="absolute top-1 left-1 bg-gray-200 rounded text-xs sm:text-sm px-2 sm:px-3 py-1">
                BUY 2 GET 1
              </p>

              <p className="absolute left-0 right-0 text-xs sm:text-sm text-gray-600 text-center font-medium bg-gray-100 px-2 sm:px-3 py-1 bottom-0">
...
{/* RIGHT Section of product section */}
          <div className="justify-center flex flex-col px-3 sm:px-0">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mb-2 sm:mb-4 underline">
                  Sheglam
                </p>
                ...
                <div className="flex items-center gap-2 sm:gap-3 mt-2 flex-wrap text-xs sm:text-sm">
                  <span className="text-xs sm:text-sm font-semibold">4.2 / <span className="text-gray-400">5</span></span>
                  <FaStar className="text-[#DCC0B6]" />
                  <span className="text-xs underline font-semibold">
                    2981 Ratings
                  </span>
                </div>
                <div className="text-xs underline font-semibold">Rate this product</div>
              ...
              <FiShare2 className="text-gray-500 text-lg cursor-pointer hover:text-black transition shrink-0" />
            </div>
{/* Select Shade Section */}
            <div className="relative justify-between items-start mt-4 sm:mt-6">
              <p className="text-xs sm:text-sm font-medium mb-3">Select Shade</p>
              <select className="w-full border rounded px-3 py-2 text-xs sm:text-sm">
